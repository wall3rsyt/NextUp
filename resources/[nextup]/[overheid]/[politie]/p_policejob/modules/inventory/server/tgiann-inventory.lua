...
Inventory = {
    ...
    registerShop = function(shopName, shopData)
        ...
        exports["tgiann-inventory"]:RegisterShop(shopName, shopData.inventory)
    end,
    addStashItem = function(stashData, itemName, itemCount, metadata, slot)
        exports["tgiann-inventory"]:AddItemToSecondaryInventory('stash', stashData.id..'_'..stashData.owner, itemName, itemCount, slot, metadata)
    end,
}
