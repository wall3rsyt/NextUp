Config = {
    MenuLanguage = 'nl', -- Change the language of the menu here
    ...
    EmojiMenuAnimalsOnly = true, -- If true, only non-human peds can use emojis
    ...
    FpsMode = true, -- set this to true if you have first-person shooting to disable the ability to crouch and shoot in third-person

    -- Crawling
    CrawlEnabled = true,
    CrawlKeybindEnabled = false,
    CrawlKeybind = '',
